...
class ImagePrims extends Primitives {
  ...
  static String[] primlist={
    ...
    "%drawstring", "3", "%drawstringr", "4","%drawpoint","3", "setfont", "3", "stringw", "1",
  ...
  public Object dispatch(int offset, Object[] args, LContext lc){
    switch(offset){
      ...
      case 4: return prim_dotdashedlineto(args[0], args[1], lc);
      case 5: return prim_shortdashedlineto(args[0], args[1], lc);
      case 6: return prim_longdashedlineto(args[0], args[1], lc);
      case 7: return prim_dotshortdashedlineto(args[0], args[1], lc);
      case 8: return prim_dotlongdashedlineto(args[0], args[1], lc);
      case 9: return prim_shortlongdashedlineto(args[0], args[1], lc);
      case 10: return prim_fillscreen(lc);
      case 11: return prim_startFill(args[0], args[1], lc);
      case 12: return prim_endFill(lc);
      case 13: return prim_dropFill(lc);
      case 14: return prim_drawstring(args[0], args[1], args[2], lc);
      case 15: return prim_drawstringr(args[0], args[1], args[2], args[3], lc);
      case 16: return prim_drawpoint(args[0], args[1], args[2], lc);
      case 17: return prim_setfont(args[0], args[1], args[2], lc);
      case 18: return prim_stringw(args[0], lc);
      case 19: color = new Color((int)Logo.aLong(args[0], lc), alpha); return null;
      // case 18: color = Logo.anInt(args[0], lc); return null;
      case 20: pensize = (float)Logo.aDouble(args[0], lc); return null;
      case 21: return prim_savepic(args[0], lc);
      case 22: return new Double(xcor);
      case 23: return new Double(ycor);
      case 24: return prim_placepic(args[0], args[1], args[2], lc);
      case 25: return prim_pixels(lc);
      case 26: return prim_setpixels(args[0], lc);
      case 27: antialias = Logo.aBoolean(args[0], lc); return null;
      case 28: alpha = Logo.aBoolean(args[0], lc); return null;
      case 29: return prim_clipFill(lc);
      case 30: clippath = null; return null;
      }
    return null;
  }
